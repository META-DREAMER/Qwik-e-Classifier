...
#define PIPE_DEPTH          4
// Pooling Kernel
#define POOL_LBUF_DEPTH     512            // YOLO - Must be large enough to hold one line (dim1/dim2)
// #define POOL_LBUF_DEPTH     224         // AlexNet Must be large enough to hold one line (dim1/dim2)
