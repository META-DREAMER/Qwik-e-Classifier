...
my $splitter_exe = $ENV{'INTELFPGAOCLSDKROOT'}."/linux64/bin"."/aocl-module-splitter";
my $aoc_exe = $ENV{INTELFPGAOCLSDKROOT}."/bin/aoc";
...
sub version()
{
  ...
  print "Version 17.1 Build 590\n";
  print "Copyright (C) 2017 Intel Corporation\n";
}
